...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="NMIT CANTEEN",fg="steel blue",bd=10,anchor='w')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 25, text="-Nagaraj GK 1NT18CS103 \n Vivek Narayan P 1NT18CS186",bd=2,relief=SUNKEN)
